...
const std::bitset<32> _rcon[] = {0x01000000, 0x02000000, 0x04000000, 0x08000000, 0x10000000,
                                 0x20000000, 0x40000000, 0x80000000, 0x1B000000, 0x36000000};
/** From https://en.wikipedia.org/wiki/Rijndael_S-box#Forward_S-box */
const std::bitset<8> _sbox[] = {
...
std::bitset<8> sbox(std::bitset<8> input) { return _sbox[input.to_ulong()]; }
/** Convenience function for looking up inverse sbox values */
std::bitset<8> inv_sbox(std::bitset<8> input) { return _inv_sbox[input.to_ulong()]; }

/** From https://en.wikipedia.org/wiki/Rijndael_MixColumns#Galois_Multiplication_lookup_tables */
const std::bitset<8> _GF_x2[] = {
...
std::bitset<8> GF_m(std::bitset<8> input, unsigned int c) {
    unsigned int i = input.to_ulong();
    switch (c) {
    case 1:
        return input;
    case 2:
