...
const std::array<BYTE, 4> _rcon[] = {{0x01, 0, 0, 0}, {0x02, 0, 0, 0}, {0x04, 0, 0, 0}, {0x08, 0, 0, 0},
...
const std::array<BYTE, 256> _sbox = {
...
const std::array<BYTE, 256> _inv_sbox = {
...
/** Convenience function for looking up sbox values */
BYTE sbox(BYTE input) { return _sbox[input]; }
/** Convenience function for looking up inverse sbox values */
BYTE inv_sbox(BYTE input) { return _inv_sbox[input]; }

/** From https://en.wikipedia.org/wiki/Rijndael_MixColumns#Galois_Multiplication_lookup_tables */
const std::array<BYTE, 256> _GF_x2 = {
...
/** From https://en.wikipedia.org/wiki/Rijndael_MixColumns#Galois_Multiplication_lookup_tables */
const std::array<BYTE, 256> _GF_x3 = {
...
/** From https://en.wikipedia.org/wiki/Rijndael_MixColumns#Galois_Multiplication_lookup_tables */
const std::array<BYTE, 256> _GF_x9 = {
...
/** From https://en.wikipedia.org/wiki/Rijndael_MixColumns#Galois_Multiplication_lookup_tables */
const std::array<BYTE, 256> _GF_x11 = {
...
/** From https://en.wikipedia.org/wiki/Rijndael_MixColumns#Galois_Multiplication_lookup_tables */
const std::array<BYTE, 256> _GF_x13 = {
...
/** From https://en.wikipedia.org/wiki/Rijndael_MixColumns#Galois_Multiplication_lookup_tables */
const std::array<BYTE, 256> _GF_x14 = {
...
/** 
 * Convenience function for looking up GF multiplication values
 * @param input byte to multiply
 * @param c One of the supported coefficients: 1, 2, 3, 9, 11, 13, 14
 */
BYTE GF_m(BYTE input, unsigned char c) {
    switch (c) {
    case 1:
        return input;
    case 2:
    ...
    case 9:
        return _GF_x9[input];
    case 11:
        return _GF_x11[input];
    case 13:
        return _GF_x13[input];
    case 14:
        return _GF_x14[input];
    default:
        throw std::domain_error("Unsupported GF field multiplication");
    }
}
} // namespace _AES_internals